  ...
  manifesto: {
    ...
    body: {
      en: [
        ...
        "SEIVA is a horizontal, international collective of three chefs. We are three distinct culinary lifelines that have crossed borders, cultures and oceans to merge into a single signature. We bring the Italian flavors and freshness of the Piedmont hills ; the vibrant, soulful tastes of the littorals and hills of Southern Brazil; and the flavorful Southern and Northeastern cuisine honed in the culinary capitals of the United States.",
...
pt: [
        ...
        "A SEIVA é um coletivo internacional horizontal de três chefs. Somos três trajetórias culinárias distintas que atravessaram fronteiras, culturas e oceanos para fundirem-se em uma única assinatura. Trazemos os sabores italianos e o frescor das colinas do Piemonte; os sabores vibrantes e cheios de alma do litoral e das serras do Sul do Brasil; e a saborosa culinária do Sul e do Nordeste dos Estados Unidos, aprimorada nas capitais gastronômicas norte-americanas."        "Não somos uma empresa de catering tradicional. Não produzimos em massa e não compramos produtos prontos de food service. Somos uma casa culinária guiada por chefs, construída exclusivamente para aqueles que enxergam uma reunião como uma experiência gastronômica como forma de arte.",
  ...
  caseStudy: {
    ...
    stats: [
      ...
      { n: "2x Iconic", l: { en: "5 Course wine-paired diners for BMW & La Roche-Posay", pt: "Jantares harmonizados de 5 etapas para BMW e La Roche-Posay" } },
    ],
  },
  experiences: {
