...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "An international high-gastronomy collective of three chefs. Private dinners, luxury brand activations and exclusive celebrations across Brazil, Italy and the United States." },
      { name: "author", content: "SEIVA" },
      { property: "og:title", content: "SEIVA — High Gastronomy, Tailor-Made" },
      { property: "og:description", content: "An international collective of three chefs crafting bespoke culinary experiences for private clients and luxury brands." },
